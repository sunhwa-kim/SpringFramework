...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("  -----------------------------  ");
		// default-autowire="byName" 영향에서 제외시키기
